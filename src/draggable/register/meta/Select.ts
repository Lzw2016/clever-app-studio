...
import { selectCacheOp, selectGridOp, selectOptions, selectTreeOp } from "@/draggable/register/JsonSchema";
                        ...
                        },
                        {
                            ...
                            cmpProps: {
                                ...
                                options: [
                                    ...
                                    { value: "grid", label: "下拉表格" },
                                ],
                            },
                            label: "下拉模式",
                            labelTips: "渲染为下拉表格或下拉树，需结合 grid-op / tree-op 使用",
                            propsName: "renderType",
                        },
                        {
                            cmp: "EditorSetter",
                            cmpProps: {
                                title: "下拉树配置",
                                jsonSchema: selectTreeOp,
                            },
                            label: "下拉树",
                            labelTips: "下拉树时，内置树组件的配置，用法同 Tree 组件。需结合 render-type 属性使用",
                            propsName: "treeOp",
                        },
                        {
                            cmp: "EditorSetter",
                            cmpProps: {
                                title: "下拉表格配置",
                                jsonSchema: selectGridOp,
                            },
                            label: "下拉表格",
                            labelTips: "下拉表格时，内置表格的配置，用法同 Grid 组件。需结合 render-type 属性使用",
                            propsName: "gridOp",
                        },
                        {
                            cmp: "SelectSetter",
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            cmp: "BoolSetter",
                            label: "默认显示",
                            labelTips: "通过 init-label 属性设置远程搜索或者嵌套树懒加载数据未获取到时显示的初始化 label 值",
                            propsName: "initLabel",
                        },
                        {
                            cmp: "BoolSetter",
                ...
                },
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            cmp: "BoolSetter",
                            label: "多选显标",
                            labelTips: "指定多选模式全选后，在输入框中，是否只显示 all-text 指定的Tag。 默认值为 false，所有选项循环显示在输入框。",
                            propsName: "showAllTextTag",
                        },
                        {
                            cmp: "BoolSetter",
                            label: "允许全选",
